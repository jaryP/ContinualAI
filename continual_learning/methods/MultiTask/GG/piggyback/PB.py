...
# from continual_learning.methods.MultiTask.GG.piggyback import PiggyBackLayer, ForwardHook
from continual_learning.methods.MultiTask.GG.piggyback.base import PiggyBackLayer, ForwardHook
